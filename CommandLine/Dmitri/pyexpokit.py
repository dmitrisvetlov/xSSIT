...
def expmv(t, A, v, tol=1e-7, krylov_dim=30):
    ...
    while t_k < t_f:
        ...
        # The w vector is initially two-dimensional (i.e. (n, 1)) but becomes 
        # one-dimensional (i.e. (n,)) after the first iteration. But v_m[0] is
        # always one-dimensional, so this differential slicing is sometimes
        # required:
